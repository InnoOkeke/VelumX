...
export function getConfig(): FrontendConfig {
  return {
    ...
    stacksPaymasterAddress: process.env.NEXT_PUBLIC_STACKS_PAYMASTER_ADDRESS || 'STKYNF473GQ1V0WWCF24TV7ZR1WYAKTC79V25E3P.paymaster-module-v7',
    stacksSmartWalletAddress: process.env.NEXT_PUBLIC_STACKS_SMART_WALLET_ADDRESS || 'STKYNF473GQ1V0WWCF24TV7ZR1WYAKTC79V25E3P.smart-wallet-v7',
    stacksWalletFactoryAddress: process.env.NEXT_PUBLIC_STACKS_WALLET_FACTORY_ADDRESS || 'STKYNF473GQ1V0WWCF24TV7ZR1WYAKTC79V25E3P.wallet-factory-v6',
