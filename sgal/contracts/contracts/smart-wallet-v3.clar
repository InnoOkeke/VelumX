...
(define-public (execute-gasless
  ...
  (let (
    ...
    ;; Point to v3 paymaster
    (try! (contract-call? 'STKYNF473GQ1V0WWCF24TV7ZR1WYAKTC79V25E3P.paymaster-module-v3 settle-fee token-trait u5000 max-fee tx-sender))
    (print { event: "execution-triggered", target: target, payload: payload })
